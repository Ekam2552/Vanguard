...
export const Footer = () => {
  return (
    <footer className="relative z-10 w-full overflow-hidden bg-[#050505] py-24 px-4 md:px-12 ring-t-1 ring-white/10 mt-32 border-t border-white/5">
      <div className="mx-auto flex max-w-7xl flex-col justify-between gap-16 md:flex-row">
        <div className="max-w-sm space-y-8">
          <h2 className="text-4xl font-light tracking-tight">Vanguard.</h2>
        ...
        <div className="grid grid-cols-2 gap-12 sm:grid-cols-3">
          <div className="space-y-4">
            <p className="text-[10px] uppercase tracking-[0.2em] text-white/40 font-medium">Studio</p>
          ...
          <div className="space-y-4">
            <p className="text-[10px] uppercase tracking-[0.2em] text-white/40 font-medium">Social</p>
            <ul className="space-y-2 text-sm text-white/70">
